...
window.onload = function() {
    var no1 = document.getElementById('number1');           //retrieves info from input text "number1" and assigns value to no1
    var no2 = document.getElementById('number2');           //retrieves info from input text "number2" and assigns value to no2
    var mySum = document.getElementById('mySum');           //will assign the value to div "mySum"
    var button1 = document.getElementById('actionButton');   //event handler tied to "actionButton" submit button
    var button2 = document.getElementById('clearNumbers');
